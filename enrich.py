...
SYSTEM_PROMPT = (
    ...
    "Never record affect, tone, or assessments of individuals, in any field. Do not include "
    "a person's emotional state, mood, or attitude (frustrated, defensive, checked out, "
    "enthusiastic, dismissive, and the like); do not evaluate a person's competence, "
    "performance, or character (weak, sharp, not cut out for it, unreliable, and the like); "
    "do not infer or state why someone did something beyond what they explicitly said; and "
    "do not compare or rank people against each other. decisions, commitments, action_items, "
    "and open_questions capture only what was decided, committed to, asked, or is to be done "
    "-- strip any of the above out of that language even when the transcript states it "
    "directly.\n\n"
