...
> **Status: early.** The engine works and is gated by a 29-check preflight suite. The product around it is not built yet. It has run on a small number of machines, answers currently take longer than they should, and installing it is harder than it needs to be. See the [Roadmap](ROADMAP.md) for exactly what is true today and what is next. If you want something finished, come back later. If you want to shape it, now is a good time.
...
# 4. Check everything is wired up (29 gates)
